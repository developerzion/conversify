...
export default function Profile() {
   ...
   return (
      <Popover className="relative">
         ...
         <PopoverPanel
            transition
            className="absolute -right-4 md:-right-6 z-10 mt-2 flex w-screen max-w-max px-4 transition data-[closed]:translate-y-1 data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in"
         >
            <div className="w-screen max-w-[15rem] flex-auto overflow-hidden rounded-xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
                  ...
                  <div className="my-5 flex items-center gap-3">
                     ...
                     <div className="flex flex-col">
                        ...
                        <div className="flex items-center font-[90] gap-1 text-[13px]">
                           ...
                           <div className="max-w-[6rem] overflow-ellipsis truncate">{email}</div>
                        </div>
                     </div>
                  </div>
                  <hr />
               ...
               <div className="px-6 pt-5 pb-8">
                  <button
                     ...
                     className="w-full text-center border border-[#5D87FF] py-[.4rem] text-[#5D87FF] hover:bg-[#5D87FF] hover:text-white rounded-md"
                  >
                     Logout
                  </button>
