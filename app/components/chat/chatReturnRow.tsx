...
const ChatReturnRow = ({ message }: IProps) => {
   ...
   const { senderMsg: sendMsg, receiverMsg: receiveMsg, senderId, sender, createdAt } = message;
         ...
         return (
            <div className="flex gap-3 mb-3">
               <div>
                  ...
                  <div className="max-w-[30rem] mt-1 py-2 px-3 rounded-lg bg-[#ECF2FF] text-[13px]">{sendMsg}</div>
               </div>
            </div>
         );
      } else {
         return (
            <div className="flex justify-end gap-3 mb-6">
               ...
               <div>
                  ...
                  <div className="max-w-[30rem] mt-1 py-2 px-3 rounded-lg bg-[#F2F6FA] text-[13px]">{receiveMsg}</div>
               </div>
            </div>
         );
      }
